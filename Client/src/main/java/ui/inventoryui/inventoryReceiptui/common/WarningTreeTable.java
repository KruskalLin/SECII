...
public class WarningTreeTable extends JFXTreeTableView<ReceiptGoodsItemVO> {
    private ObservableList<ReceiptGoodsItemVO> list;

    public WarningTreeTable() {
        super();
        ...
        JFXTreeTableColumn<ReceiptGoodsItemVO, String> warningNum = new OrdinaryStringColumn<>("报警数量", 115.5, "warningNum");
...
//            row.setPrefHeight(55);
        ...
        this.getColumns().setAll(goodsID, goodsName, inventoryNum, warningNum);
    }
